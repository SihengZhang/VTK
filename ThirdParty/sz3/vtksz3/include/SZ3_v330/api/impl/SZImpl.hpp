#ifndef SZ3_V330_IMPL_SZ_HPP
#define SZ3_V330_IMPL_SZ_HPP

#include "SZ3_v330/api/impl/SZDispatcher.hpp"
#include "SZ3_v330/api/impl/SZImplOMP.hpp"
...
template <class T>
size_t SZ_compress_size_bound_v330(const Config &conf) {
