#ifndef SZ3_V330_IMPL_SZDISPATCHER_HPP
#define SZ3_V330_IMPL_SZDISPATCHER_HPP

#include "SZ3_v330/api/impl/SZAlgoInterp.hpp"
#include "SZ3_v330/api/impl/SZAlgoLorenzoReg.hpp"
#include "SZ3_v330/api/impl/SZAlgoNopred.hpp"
...
size_t SZ_compress_dispatcher(Config &conf, const T *data, uchar *cmpData, size_t cmpCap) {
    ...
    if (conf.cmprAlgo != ALGO_LOSSLESS) {
        try {
            ...
            if (std::string(e.what()) == SZ3_V330_ERROR_COMP_BUFFER_NOT_LARGE_ENOUGH) {
