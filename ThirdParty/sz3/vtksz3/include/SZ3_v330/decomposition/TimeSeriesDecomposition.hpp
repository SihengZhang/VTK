#ifndef SZ3_V330_TIME_SERIES_DECOMPOSITION_HPP
#define SZ3_V330_TIME_SERIES_DECOMPOSITION_HPP

#include "Decomposition.hpp"
#include "SZ3_v330/def.hpp"
#include "SZ3_v330/predictor/LorenzoPredictor.hpp"
#include "SZ3_v330/predictor/Predictor.hpp"
#include "SZ3_v330/quantizer/Quantizer.hpp"
   ...
   public:
    ...
    std::vector<int> compress(const Config &conf, T *data) override {
        ...
        if (data_ts0 != nullptr) {
            ...
            auto inter_block_range = std::make_shared<SZ3_v330::multi_dimensional_range<T, N - 1>>(
                data, std::begin(global_dims), std::end(global_dims), stride, 0);
            auto intra_block_range = std::make_shared<SZ3_v330::multi_dimensional_range<T, N - 1>>(
