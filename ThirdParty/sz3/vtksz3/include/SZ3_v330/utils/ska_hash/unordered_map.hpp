...
using ska_v330::detailv3_v330::functor_storage;
using ska_v330::detailv3_v330::KeyOrValueHasher;
using ska_v330::detailv3_v330::KeyOrValueEquality;
using ska_v330::detailv3_v330::AssignIfTrue;
using ska_v330::detailv3_v330::HashPolicySelector;
...
{
    using Entry = detailv10_v330::sherwood_v10_entry<T, ArgumentAlloc>;
...
class unordered_map
        : public detailv10_v330::sherwood_v10_table
        <
            std::pair<K, V>,
            K,
            H,
            detailv10_v330::KeyOrValueHasher<K, std::pair<K, V>, H>,
            E,
            detailv10_v330::KeyOrValueEquality<K, std::pair<K, V>, E>,
            A,
            typename std::allocator_traits<A>::template rebind_alloc<detailv10_v330::sherwood_v10_entry<std::pair<K, V>, A>>,
            typename std::allocator_traits<A>::template rebind_alloc<typename std::allocator_traits<A>::template rebind_traits<detailv10_v330::sherwood_v10_entry<std::pair<K, V>, A>>::pointer>
        >
{
    using Table = detailv10_v330::sherwood_v10_table
    <
        std::pair<K, V>,
        K,
        H,
...
class unordered_set
        ...
        <
            ...
            T,
            H,
            detailv10_v330::functor_storage<size_t, H>,
            E,
            detailv10_v330::functor_storage<bool, E>,
            A,
            typename std::allocator_traits<A>::template rebind_alloc<detailv10_v330::sherwood_v10_entry<T, A>>,
            typename std::allocator_traits<A>::template rebind_alloc<typename std::allocator_traits<A>::template rebind_traits<detailv10_v330::sherwood_v10_entry<T, A>>::pointer>
        >
{
    using Table = detailv10_v330::sherwood_v10_table
    <
