...
class bytell_hash_map
        : public detailv8_v330::sherwood_v8_table
        <
            std::pair<K, V>,
            K,
            H,
            detailv8_v330::KeyOrValueHasher<K, std::pair<K, V>, H>,
            E,
            detailv8_v330::KeyOrValueEquality<K, std::pair<K, V>, E>,
            A,
            typename std::allocator_traits<A>::template rebind_alloc<unsigned char>,
            detailv8_v330::CalculateBytellBlockSize<K, V>::value
        >
{
    using Table = detailv8_v330::sherwood_v8_table
    <
        std::pair<K, V>,
        K,
        H,
...
class bytell_hash_set
        ...
        <
            ...
            T,
            H,
            detailv8_v330::functor_storage<size_t, H>,
            E,
            detailv8_v330::functor_storage<bool, E>,
            A,
            typename std::allocator_traits<A>::template rebind_alloc<unsigned char>,
            detailv8_v330::CalculateBytellBlockSize<T>::value
        >
{
    using Table = detailv8_v330::sherwood_v8_table
    <
